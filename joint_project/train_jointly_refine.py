...
for fbp_folder in fbp_folders:
    ...
    joint_folder = os.path.join(os.environ['OV_DATA_BASE'], 'trained_models', 'OV04',
                                'pod_2d', 'joint_rest_seg_refine_{}_{}'.format(dose, loss_weight))
    ...
    seg_model = SegmentationModel(val_fold=5+vf,
                                  data_name='OV04',
    ...
    model_path = os.path.join(joint_folder, 'fold_{}'.format(5+vf))
