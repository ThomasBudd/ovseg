...
prev_stages = [{'data_name':'OV04',
               ...
               {'data_name': 'OV04',
                ...
                'model_name': 'U-Net5'},
               {'data_name': 'OV04',
                'preprocessed_name': 'multiclass_reg_1_2_9_13_15_17',
                'model_name': 'regfinding_0.001'}]
...
def get_bin_pred(data_tpl):
    ...
    return np.max(np.stack(prev_preds), 0)
...
for i in tqdm(range(len(ds))):
    ...
    bin_pred = get_bin_pred(data_tpl)
    reg = data_tpl[keys_for_previous_stages[-1]]
    pred = reg*bin_pred
