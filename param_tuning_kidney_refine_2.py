...
wd = 1e-4
n_bias_samples = [0, 1, 2, 3, 5, 6, 7, 8, 9, 10][args.i]
...
model_params['data']['trn_dl_params']['min_biased_samples'] = n_bias_samples
...
model_name = f'n_bias_samples_{n_bias_samples}'
