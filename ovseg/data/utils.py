...
def crop_and_pad_image(volume, coord, patch_size, padded_patch_size):
    '''
...
def split_scans_by_patient_id(scans, patient_ids, n_folds=5,
                              fixed_shuffle=True):
    ...
    scans_used = []
    scan_tuples = []
    patient_id_list = [patient_ids[scan] for scan in scan]
    for scan in scans:
